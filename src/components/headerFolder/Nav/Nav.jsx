...
const Nav = () => {
    ...
    return (
        ...
        <div className={scss.linkWrapper}>
            ...
            {isActive === true ? <NavLink to={'notices/sell?page=1&limit=8'} className={scss.linkMain} onClick={()=>dispatch(setMenuActive(!isActive))}>Find pet</NavLink> : <NavLink to={'notices/sell?page=1&limit=8'} className={scss.linkMain}>Find pet</NavLink>}
