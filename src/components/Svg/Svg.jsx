...
const SvgInsert = ({ id }) => {
  switch (id) {
    ...
    case 'icon-close':
      return (
        <svg id="icon-close" viewBox="0 0 32 32" width="20" height="20">
    ...
    case 'icon-add-avatar':
      return (
        <svg id="icon-add-avatar" viewBox="0 0 31 32" className={scss.iconEditAvatar}>
          <path
            stroke="#111"
            strokeLinejoin="miter"
            strokeLinecap="round"
    ...
    case 'icon-male':
      return (
        <svg id="icon-male" viewBox="0 0 32 32">
          <path
            fill="#23c2ef"
    ...
    case 'icon-female':
      return (
        <svg id="icon-female" viewBox="0 0 21 32">
          <path
            fill="#ff8787"
    ...
    case 'icon-edit-avatar':
      return (
        <svg id="icon-edit-avatar" viewBox="0 0 30 32" width="20" height="20">
