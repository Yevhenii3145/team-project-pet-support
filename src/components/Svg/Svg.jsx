...
const SvgInsert = ({ id }) => {
  ...
  switch (id) {
    ...
    case 'icon-edit':
      return (
        <svg id="icon-edit" viewBox="0 0 32 32" width="12.5" height="12.5" className={scss.iconEdit}>
          <path d="M6.976 26.214c-0.165-0-0.328-0.035-0.48-0.102s-0.287-0.164-0.398-0.286c-0.113-0.121-0.2-0.264-0.254-0.421s-0.074-0.323-0.059-0.488l0.292-3.207 13.474-13.469 4.211 4.21-13.47 13.468-3.207 0.292c-0.036 0.003-0.072 0.005-0.108 0.005zM24.603 11.608l-4.21-4.21 2.525-2.525c0.111-0.111 0.242-0.199 0.386-0.258s0.299-0.091 0.456-0.091c0.156 0 0.311 0.031 0.456 0.091s0.276 0.148 0.387 0.258l2.525 2.525c0.111 0.111 0.199 0.242 0.259 0.386s0.091 0.299 0.091 0.456c0 0.156-0.031 0.311-0.091 0.456s-0.148 0.276-0.259 0.386l-2.525 2.525z"></path>
        </svg>
      );
    case 'icon-edit-active':
      return (
        <svg id="icon-edit" viewBox="0 0 32 32" width="12.5" height="12.5" className={scss.iconEdit_active}>
          <path d="M6.976 26.214c-0.165-0-0.328-0.035-0.48-0.102s-0.287-0.164-0.398-0.286c-0.113-0.121-0.2-0.264-0.254-0.421s-0.074-0.323-0.059-0.488l0.292-3.207 13.474-13.469 4.211 4.21-13.47 13.468-3.207 0.292c-0.036 0.003-0.072 0.005-0.108 0.005zM24.603 11.608l-4.21-4.21 2.525-2.525c0.111-0.111 0.242-0.199 0.386-0.258s0.299-0.091 0.456-0.091c0.156 0 0.311 0.031 0.456 0.091s0.276 0.148 0.387 0.258l2.525 2.525c0.111 0.111 0.199 0.242 0.259 0.386s0.091 0.299 0.091 0.456c0 0.156-0.031 0.311-0.091 0.456s-0.148 0.276-0.259 0.386l-2.525 2.525z"></path>
        </svg>
      );
    ...
    case 'icon-done':
      return (
        <svg id="icon-done" viewBox="0 0 32 32" width="12.5" height="12.5" className={scss.iconDone}>
          <path d="M26.976 5.252c0.923 0.879 0.959 2.34 0.080 3.263l-14.646 15.385c-0.436 0.458-1.040 0.716-1.671 0.716s-1.236-0.259-1.671-0.716l-6.892-7.24c-0.879-0.923-0.843-2.384 0.080-3.263s2.384-0.843 3.263 0.080l5.221 5.484 12.975-13.629c0.879-0.923 2.339-0.959 3.263-0.080z"></path>
        </svg>
      );
    ...
    case 'icon-close':
      return (
       ...
       <svg id="icon-close" viewBox="0 0 32 32" width="20" height="20" className={scss.iconClose}>
    ...
    case 'icon-add-avatar':
      return (
        <svg id="icon-add-avatar" viewBox="0 0 31 32" className={scss.iconAddAvatar}>
          <path
            stroke="#111"
            strokeLinejoin="miter"
            strokeLinecap="round"
    ...
    case 'icon-delete':
      return (
        <svg id="icon-delete" viewBox="0 0 29 32" width="20" height="20" className={scss.iconDelete}>
    ...
    case 'icon-edit-avatar':
      return (
        <svg id="icon-edit-avatar" viewBox="0 0 30 32" width="20" height="20" className={scss.iconEditAvatar}>
    ...
    case "icon-google" :
      return (
        <svg id="icon-google" viewBox="0 0 32 32" width="30" height="30" className={scss.google}>
<path fill="#e94335" d="M2.65 9.119c0.969-2.019 2.337-3.725 4.063-5.144 2.338-1.931 5.019-3.094 8.025-3.45 3.531-0.419 6.85 0.25 9.919 2.087 0.762 0.456 1.475 0.975 2.156 1.538 0.169 0.138 0.15 0.219 0.006 0.356-1.394 1.388-2.788 2.775-4.169 4.175-0.163 0.162-0.25 0.15-0.425 0.019-4.050-3.119-9.956-2.275-12.975 1.85-0.531 0.725-0.963 1.506-1.263 2.356-0.025 0.075-0.075 0.144-0.112 0.219-0.806-0.613-1.619-1.225-2.419-1.844-0.938-0.719-1.875-1.438-2.806-2.162z"></path>
<path fill="#34a853" d="M7.875 18.988c0.269 0.594 0.494 1.212 0.831 1.769 1.419 2.325 3.444 3.819 6.113 4.35 2.406 0.481 4.719 0.156 6.875-1.050 0.075-0.038 0.15-0.075 0.219-0.113 0.038 0.038 0.069 0.081 0.106 0.113 1.613 1.25 3.231 2.5 4.844 3.75-0.775 0.769-1.656 1.387-2.594 1.925-2.719 1.55-5.662 2.175-8.762 1.938-3.863-0.3-7.194-1.825-9.944-4.575-1.206-1.206-2.2-2.569-2.919-4.125 0.669-0.512 1.337-1.019 2.006-1.531 1.075-0.819 2.15-1.631 3.225-2.45z"></path>
<path fill="#4285f3" d="M26.869 27.806c-1.613-1.25-3.231-2.5-4.844-3.75-0.038-0.031-0.075-0.075-0.106-0.113 0.556-0.431 1.125-0.85 1.581-1.4 0.762-0.913 1.269-1.944 1.531-3.1 0.031-0.144 0.006-0.194-0.137-0.188-0.075 0.006-0.144 0-0.219 0-2.55 0-5.106-0.006-7.656 0.006-0.281 0-0.344-0.075-0.337-0.344 0.012-1.813 0.012-3.625 0-5.438 0-0.231 0.063-0.294 0.294-0.294 4.675 0.006 9.35 0.006 14.031 0 0.2 0 0.281 0.050 0.331 0.262 0.381 1.719 0.356 3.444 0.125 5.181-0.188 1.387-0.525 2.731-1.044 4.031-0.769 1.919-1.9 3.594-3.387 5.031-0.056 0.044-0.113 0.075-0.163 0.113z"></path>
<path fill="#fabb06" d="M7.875 18.988c-1.075 0.819-2.15 1.631-3.225 2.45-0.669 0.506-1.337 1.019-2.006 1.531-0.519-0.962-0.856-1.981-1.131-3.031-0.525-2.031-0.606-4.094-0.319-6.162 0.225-1.625 0.694-3.188 1.45-4.65 0.938 0.719 1.869 1.444 2.806 2.162 0.806 0.619 1.612 1.231 2.419 1.844-0.138 0.669-0.331 1.325-0.394 2.013-0.112 1.25 0.006 2.469 0.362 3.669 0.025 0.050 0.031 0.113 0.037 0.175z"></path>
</svg>
      );
