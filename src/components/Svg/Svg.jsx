...
const SvgInsert = ({ id }) => {
  switch (id) {
    case 'icon-logo':
      return (
        <svg id="icon-logo" viewBox="0 0 89 32" width="88" height="42px">
          <path
            fill="#000"
    ...
    case 'icon-add-avatar':
      return (
        <svg id="icon-add-avatar" viewBox="0 0 31 32">
          <path
            stroke="#111"
    ...
    case 'icon-delete':
      return (
        <svg id="icon-delete" viewBox="0 0 29 32">
    ...
    case 'icon-heart':
      return (
        <svg id="icon-heart" viewBox="0 0 35 32">
          <path
            fill="#fff"
            opacity="0.6"
    ...
    case 'icon-edit-avatar':
      return (
        <svg id="icon-edit-avatar" viewBox="0 0 30 32">
