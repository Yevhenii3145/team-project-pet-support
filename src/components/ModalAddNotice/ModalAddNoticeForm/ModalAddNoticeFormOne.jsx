    ...
    return (
        <div className={scss.modalAdds_page}>
            ...
            <div className={scss.modalAdds_page_box}>
                    <label className={scss.modalAdds_page__label} >Tittle of ad*</label>
                    <input className={scss.modalAdds_page__input} type="text" name='title' placeholder="Type name pet"/>
                </div>
                <div className={scss.modalAdds_page_box}>
